...
public class PrivacyItem {
    ...
    private boolean filterLocationMe = false;    //// by kanama
    ...
    public boolean isFilterLocationMe() {
		return filterLocationMe;                  /////////////////   by kanama
	}
    ...
    public void setFilterLocationMe(boolean filterLocationMe) {      /////////////// by kanama
		this.filterLocationMe = filterLocationMe;
	}
    ...
    public boolean isFilterEverything() {
		return !(this.isFilterIQ() || this.isFilterMessage() || this.isFilterLocationMe() || this.isFilterPresence_in()
    ...
    public String toXML() {
        ...
        if (isFilterEverything()) {
        	...
        	if (this.isFilterLocationMe()){     ////////// by kanama
        		buf.append("location/>");    
        	}
