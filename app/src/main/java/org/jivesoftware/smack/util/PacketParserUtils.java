...
public class PacketParserUtils {
    ...
    /////////  Parses a location packet.
    
    public static Packet parseLocationMe(XmlPullParser parser) throws Exception {  ////////by kanama
    	LocationMe message = new LocationMe();
        String id = parser.getAttributeValue("", "id");
        message.setPacketID(id == null ? Packet.ID_NOT_AVAILABLE : id);
        message.setTo(parser.getAttributeValue("", "to"));
        message.setFrom(parser.getAttributeValue("", "from"));
        message.setType(LocationMe.Type.fromString(parser.getAttributeValue("", "type")));
